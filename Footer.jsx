    ...
    <footer className='bg-gray-800 text-white py-12 px-4 md:px-0'>
      <div className='max-w-6xl mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
                <h3 className='text-xl font-bold mb-4'>Grocify</h3>
            ...
            <div>
                <h3 className='text-xl font-bold mb-4'>Contact</h3>
                                <p className='mb-2'>Company-GroCify</p>
                                                <p className='mb-2'>Founder-Nilesh Bagade</p>
                <p className='mb-2'>Amaravti, Maharashtra</p>
                <p className='mb-2'>Phone: 9845376948</p>
                <p className='mb-2'>Email: nilbagde@Grofify.com</p>
            </div>
        </div>
